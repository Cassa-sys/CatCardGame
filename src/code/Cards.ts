...
export var Cards = [
    new Card("Pat the Cat!", "Raises Annoyance by 5.", 1, "Energy", () => {Enemy.changeHealth(-5 - playerStatus.strength.amount)}),
    new Card("Bandage", "Heal 5", 1, 'Energy', () => {Player.changeHealth(5)}),
    new Card("Move Away", "Block 5", 1, 'Energy', () => {Player.changeBlock(5)}),
    new Card("Coffee Shot", "Gain 1 Energy\nTake 5 Damage", 5, 'Health', () => {Player.energy += 1}),
